// ═══════════════════════════════════════════════════════════════════════════════
// validacionEgresos.js — Motor de reglas de digitación de egresos
// ─────────────────────────────────────────────────────────────────────────────
// EGRESO-INTELIGENTE-001
//
// PROBLEMA QUE RESUELVE
// ---------------------
// La auditoría del ERI de julio 2026 encontró que casi todos los errores del
// estado de resultados nacen en la DIGITACIÓN del egreso, no en el cálculo:
//
//   · $18.316 de IVA descontable dentro de la categoría "Nómina".
//     La nómina no genera IVA. Era una factura de un tercero mal categorizada.
//     Nadie lo vio durante un mes.
//   · "ANTICIPO DE NOMINA" registrado en categoría `Nómina` y "nomina luz"
//     registrado en categoría `anticipos de nomina` — cruzados en los dos
//     sentidos. Ningún total por separado era confiable.
//   · Un CxP de "compra de nitrógeno" con fecha 2026-08-02 dentro del
//     informe de julio.
//
// Ninguno de esos errores era detectable a simple vista en una lista de 800
// registros. Todos eran detectables por una regla.
//
// FILOSOFÍA
// ---------
// ADVERTIR, NO BLOQUEAR. Siempre hay excepciones legítimas y un digitador
// bloqueado inventa un atajo peor (registrar en "Otros"). El sistema explica
// el error, deja guardar si la persona confirma, y GUARDA LA ADVERTENCIA en el
// documento. Así el ERI puede mostrar después "12 egresos guardados con
// advertencia" y la gerente sabe dónde mirar.
//
// USO
// ---
//   Backend:  const { validarEgreso } = require('../services/validacionEgresos');
//   Frontend: import { validarEgreso } from './utils/validacionEgresos';
//
//   const { alertas, bloqueantes, resumen } = validarEgreso(egreso, contexto);
//
// Este archivo NO tiene dependencias — es JS puro para poder vivir en los dos
// lados sin tocar la configuración de build.
// ═══════════════════════════════════════════════════════════════════════════════
